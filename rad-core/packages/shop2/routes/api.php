...
use core\Packages\shop\src\controllers\ShopDeliveryController;
...
Route::group(['prefix' => $prefix], function () {
    ...
    Route::group(['middleware' => ['jwt']], function () {
        ...
        Route::post('address_default/{id}', [UserShopPackageController::class, 'address_default']);
...
$prefix = config('core.prefix') . '/shop_geo';

Route::group(['prefix' => $prefix] , function(){
 Route::get('/area/{id}' , [WithOutLoginController::class , 'geo_area']);
 Route::get('/city/{id}' , [WithOutLoginController::class , 'geo_city']);
 Route::get('/province' , [WithOutLoginController::class , 'geo_province']);

});
$prefix = config('core.prefix') . '/shop_delivery';

Route::group(['prefix' => $prefix], function () {
    Route::group(['middleware' => ['jwt']], function () {

         Route::get('/list','ShopDeliveryController@list');
        Route::get('/', 'ShopDeliveryController@index');

        Route::post('/', 'ShopDeliveryController@store');
        Route::get('/{id}', 'ShopDeliveryController@show');
        Route::put('/{id}', 'ShopDeliveryController@update');
        Route::delete('/', 'ShopDeliveryController@delete');
    });
});
