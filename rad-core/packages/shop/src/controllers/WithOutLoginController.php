...
class WithOutLoginController extends Controller
{
    ...
    public function company_index(Request $request, $city = '8')
    {
        ...
        $companies = ShopUser::with('photo' , 'back_ground')->whereHas('Cities', function ($query) use ($city) {
    ...
    public function company_show($id)
    {
        ...
        $companies = ShopUser::with('brands', 'photo', "contacts" , 'back_ground' , 'Categories')->whereHas('Cities', function ($query) use ($id) {
